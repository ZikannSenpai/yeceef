...
const GENS: Gen[] = [
    {
        id: 1,
        title: "Yuzaki Creator • GEN 1",
        desc: "para sesepuh.",
        members: 37
    },
    { id: 2, title: "Yuzaki Creator • GEN 2", desc: "CLOSE", members: 0 },
    { id: 3, title: "Yuzaki Creator • GEN 3", desc: "CLOSE", members: 0 },
    { id: 4, title: "Yuzaki Creator • GEN 4", desc: "CLOSE", members: 0 }
];

const ADMINS: Admin[] = [
    {
        name: "Zikann",
        username: "@zikannsenpai",
        title: "Coder Admin",
        desc: "atmin pedeef.",
        avatar: ""
    },
    {
        name: "Yece Ryu",
        username: "@yecer.official",
        title: "CO-ADMIN",
        desc: "Fokus koordinasi anggota, konten, dan aktivitas TikTok marga.",
    ...
    },
    {
        ...
        username: "@mika.yece",
        title: "MEDIA ADMIN",
        desc: "Ngurus visual, archive konten, dan highlight anime marga.",
...
export default function MargaClient() {
    ...
    return (
        <main className="manga-bg min-h-screen overflow-x-hidden">
            ...
            >
                <div>
                    <div className="mb-3 inline-flex items-center gap-2 rounded-full border border-cyan-300/20 px-3 py-1 text-[10px] font-bold uppercase tracking-[.24em] text-cyan-300">
                        <ShieldCheck size={14} /> Marga TikTok Anime
                    </div>
                    ...
                    <div className="mt-8 flex flex-wrap gap-3">
                        ...
                        >
                            <Info size={17} className="mr-1 inline" /> INFO
                        </a>
                    </div>
            ...
            >
                <div className="manga-panel diagonal rounded-2xl p-7">
                    <div className="relative z-10 grid gap-8 md:grid-cols-[1fr_auto] md:items-center">
                        <div>
                            ...
                            <p className="mt-3 max-w-xl text-sm leading-7 text-slate-400">
                                Jumlah ditotal dari semua generasi yang
                                terdaftar di halaman marga.
                            </p>
                        </div>
